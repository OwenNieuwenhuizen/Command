...
#include <GDep/Top/GDepTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    GDep::setupTopology(inputs);
    GDep::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    GDep::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
