// ======================================================================
// \title  GDepTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef GDEP_GDEPTOPOLOGYDEFS_HPP
#define GDEP_GDEPTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "GDep/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `GDep::TopologyState`. Only the type
