// ======================================================================
// \title  GDepTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <GDep/Top/GDepTopologyAc.hpp>
#include <GDep/Top/GDepPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(GDepPacketsPkts, GDepPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name GDep
namespace GDep {
