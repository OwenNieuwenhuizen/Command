// ======================================================================
// \title  GDepTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GDEP_GDEPTOPOLOGY_HPP
#define GDEP_GDEPTOPOLOGY_HPP
// Included for access to GDep::TopologyState and GDep::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <GDep/Top/GDepTopologyDefs.hpp>

// Remove unnecessary GDep:: qualifications
using namespace GDep;
namespace GDep {
/**
 ...
 * GDep::TopologyState see: GDepTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type GDep::TopologyState see: GDepTopologyDefs.hpp.
 *
